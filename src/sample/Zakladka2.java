...
public class Zakladka2 {
    ...
    public void liczStatystyki(ActionEvent actionEvent){
        if (!table.getItems().isEmpty()) {
            ...
            for (Czlowieczek czlowieczek : table.getItems()) {
                ...
                avWiek /= n;
                avWzrost /= n;
                System.out.println(avWiek+","+avWzrost+","+n);
    ...
    public void handleClick(ActionEvent actionEvent) {
        ...
        if (nowy.sprawdz()) {
            ...
            parentController.getTabela_dane().add(nowy);
        }

    }
    public void aktualizujTabele() {
        if (!this.parentController.getTabela_dane().isEmpty()) {
            table.setItems(parentController.getTabela_dane());
        }
    }
